...
class Tester:
    ...
    def execute(self, *, browser = '', url = '', driver_path = '',
                ...
                report_path = '', wait_seconds = 5, sleep_time = 0, debug_mode = False):
        ...
        if report_path:
            ...
            reporter.createReport(self.assertion_manager.getResults())
    ...
    # Assertionerのメソッドを実行
    def executeAssertionerMethod(self, testcase_name, process_name, assertion):
        config = self.test_builder.getConfig()
        ...
        self.assertion_manager.assertion(testcase_name, assertion_key, param_list)
